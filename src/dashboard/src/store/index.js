...
// console.log('store')
// https://en.wikipedia.org/w/api.php?action=query&origin=*&format=json&generator=search&gsrnamespace=0&gsrlimit=5&gsrsearch=%27New_England_Patriots
// let url = 'https://en.wikipedia.org/w/api.php?action=opensearch&origin=*&search={River_Dee,_Aberdeenshire}&format=json'
